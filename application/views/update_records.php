...
<body>
 <?php
  ...
  <div class="container mt-5 mb-5" style = " box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
    <div class="row">
      <div class="col-sm">
        <img src="https://image.freepik.com/free-vector/software-update-illustration_108061-429.jpg" 
      ...
      <form method="post">
        ...
        <div class="input-group col-lg-12 mb-4">
          ...
          <input id="name" type="text" name="name" placeholder="Enter Name" value="<?php echo $row->name; ?>"
        ...
        <div class="input-group col-lg-12 mb-4">
          ...
          <input id="name" type="text" name="email" placeholder="Enter Email Address" value="<?php echo $row->email; ?>"
          class="form-control bg-dark text-light border-left-0 border-md" style="padding:10px">
        </div>
        ...
        <div class="input-group col-lg-12 mb-4">
          ...
          <input id="name" type="number" name="mobile" placeholder="Enter Mobile Number" value="<?php echo $row->mobile; ?>"
          class="form-control bg-dark text-light border-left-0 border-md" style="padding:10px;">
        </div>

        <div class="text-center mt-3">
          <button type="submit" class="btn btn-primary mb-2" name="update" value="Save Data"><h4><i class="fa fa-paper-plane" aria-hidden="true">
            </i> Update </h4>
        </button>
        </div>  
    	</form>
